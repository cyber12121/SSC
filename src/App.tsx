...
import mockErrorsData from './data/mockErrors.json';
import chapterBankData from './data/chapterBank.json';
...
export default function App() {
  ...
  const mockData = mockErrorsData as SubjectData;
  const bankData = chapterBankData as SubjectData;
